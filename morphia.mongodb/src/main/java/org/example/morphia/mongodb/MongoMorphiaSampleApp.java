package org.example.morphia.mongodb;

import org.example.morphia.mongodb.dao.CustomerDao;
import org.example.morphia.mongodb.dao.impl.CustomerDaoImpl;
import org.example.morphia.mongodb.entity.Address;
import org.example.morphia.mongodb.entity.Customer;

/**
 * Sample Application which connects to MongoDB using Morphia.
 *
 */
public class MongoMorphiaSampleApp {
